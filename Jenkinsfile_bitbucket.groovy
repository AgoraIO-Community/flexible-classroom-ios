...
@Field def repoName = "open-flexible-classroom-ios"
...
@Field def companionReposConfig = [
    ...
    "open-flexible-classroom-ios": "ssh://git@git.agoralab.co/aduc/open-flexible-classroom-ios.git"
]
    ...
    withKnownErrorHandling {
        timestamps {
            ...
            def buildParams = [
                ...
                string(name: 'certificate', value: '2'),
