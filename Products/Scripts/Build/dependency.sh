...
AgoraClassroomSDK_iOS_URL="${Artifactory_iOS_URL}/AgoraClassroomSDK_iOS/release_2.8.40/dev/AgoraClassroomSDK_iOS_2.8.40.zip"
AgoraEduUI_URL="${Artifactory_iOS_URL}/AgoraEduUI/release_2.8.40/dev/AgoraEduUI_2.8.40.zip"
...
AgoraWidgets_URL="${Artifactory_iOS_URL}/AgoraWidgets/release_2.8.50/dev/AgoraWidgets_2.8.50.zip"

AgoraEduCore_URL="${Artifactory_iOS_URL}/AgoraEduCore/release_2.8.50/dev/AgoraEduCore_2.8.50.zip"
