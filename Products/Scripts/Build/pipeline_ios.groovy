...
compileConfig = [
    "sourceDir": "open-flexible-classroom-ios",
    "non-publish": [
...
def doPublish(buildVariables) {
    ...
    def archiveInfos = [
        [
          "type": "ARTIFACTORY",
          "archivePattern": "*.zip",
          "serverPath": "Flexible_ClassRoom_iOS/${shortVersion}/${buildVariables.buildDate}/${env.platform}",
...
pipelineLoad(this, "Flexible_ClassRoom_iOS", "build", "ios", "shadow && mac")