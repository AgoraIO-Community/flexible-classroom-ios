...
class FcrAppUIJoinRoomInputView: UIView,
                                 AgoraUIContentContainer {
    let idTextField = FcrAppUIRoomIdTextField()
    
    let nameTextField = FcrAppUIRoomNameTextField()
    ...
    func updateViewProperties() {
        idTextField.iconImageView.image = UIImage(named: "fcr_v2_id")
        ...
        nameTextField.iconImageView.image = UIImage(named: "fcr_name")
